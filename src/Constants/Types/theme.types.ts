...
type TColorSet = {
  ...
  infoOnWhite: { value: string, hover: string },
...
export const colorSchemeLight: TColorScheme = {
  color: {
    ...
    infoOnWhite: { value: _.gray2, hover: _.white0 },
  ...
  borderColor: {
    ...
    infoOnWhite: { value: _.transparent0, hover: _.transparent0 },
...
export const colorSchemeDark: TColorScheme = {
  color: {
    ...
    warning: { value: _.darkblue2, hover: _.white0 },
    info: { value: _.white0, hover: _.white0 },
    infoOnWhite: { value: _.white0, hover: _.white0 },
    link: { value: _.white0, hover: _.white0 },
    error: { value: _.white0, hover: _.white0 },
  },
  backgroundColor: {
    primary: { value: _.darkblue2, hover: _.blue1 },
